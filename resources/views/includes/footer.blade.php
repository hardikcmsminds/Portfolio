<!-- footer start (Add "light" class to #footer in order to enable light footer) -->
      ...
      <section class="footerbg">
  		...
  		href="tel:+079 4890 7823">079 4890 7823</a></span>
              ...
              <div class="footer-bottom">
                  <div class="container">
                      <p class="text-center"> cmsMinds-All rights reserved &copy; {{ date('Y') }}.</p>
                  </div>
              </div>
          </footer>
      </section>
    ...
    <!--script type="text/javascript" src="{{ URL::asset('template/frontend/app.js') }}"></script-->
    <script type="text/javascript" src="{{ URL::asset('template/frontend/height.js') }}"></script>
    <script src="{{ URL::asset('template/frontend/wow.min.js') }}" type="text/javascript"></script>
    <!--script src="{{ URL::asset('template/frontend/cscript.js') }}" type="text/javascript"></script-->
    <!--script type="text/javascript" src="{{ URL::asset('template/frontend/bootstrap/js/bootstrap.min.js') }}"></script-->
    <!-- Modernizr javascript -->
    <script type="text/javascript" src="{{ URL::asset('template/frontend/plugins/modernizr.js') }}"></script>
    <!-- jQuery REVOLUTION Slider  -->
    <script type="text/javascript" src="{{ URL::asset('template/frontend/plugins/rs-plugin/js/jquery.themepunch.tools.min.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('template/frontend/plugins/rs-plugin/js/jquery.themepunch.revolution.min.js') }}"></script>
    <!-- Isotope javascript -->
    <script type="text/javascript" src="{{ URL::asset('template/frontend/plugins/isotope/isotope.pkgd.min.js') }}"></script>
    <!-- Owl carousel javascript -->
    <script type="text/javascript" src="{{ URL::asset('template/frontend/plugins/owl-carousel/owl.carousel.js') }}"></script>
    <!-- Magnific Popup javascript -->
    <script type="text/javascript" src="{{ URL::asset('template/frontend/plugins/magnific-popup/jquery.magnific-popup.min.js') }}"></script>
    <!-- Appear javascript -->
    <script type="text/javascript" src="{{ URL::asset('template/frontend/plugins/jquery.appear.js') }}"></script>
    <!-- Count To javascript -->
    <script type="text/javascript" src="{{ URL::asset('template/frontend/plugins/jquery.countTo.js') }}"></script>
    <!-- Parallax javascript -->
    <script src="{{ URL::asset('template/frontend/plugins/jquery.parallax-1.1.3.js') }}"></script>
    <!-- Contact form -->
    <script src="{{ URL::asset('template/frontend/plugins/jquery.validate.js') }}"></script>
    <!-- Initialization of Plugins -->
    <script type="text/javascript" src="{{ URL::asset('template/frontend/js/template.js') }}"></script>
    <!-- Custom Scripts -->
    <script type="text/javascript" src="{{ URL::asset('template/frontend/js/custom.js') }}"></script>
    <script src="{{ URL::asset('template/frontend/js_live/jquery.min.js') }}"></script>
    <script src="{{ URL::asset('template/frontend/js_live/bootstrap.min.js') }}"></script>
    ...
    $(".filter-button").click(function(){
        var filter_slector = $(this);
        var value = filter_slector.attr('data-filter');
        if(value == "all"){
        ...
        if ($(".filter-button").parent().hasClass("active")) {
            $(".filter-button").parent().removeClass("active");
        }
        filter_slector.parent().addClass("active");
    });
    ...
    <script type="text/javascript">
           ...
           /* $( document ).ready(function() {
            ...
            /*function getdata(){
                var cat = $("#category_list li.active a").data('filter');
                var tech_offset = $("article.portfolio-item."+cat).size();
               // var tokenvalue = $("#tokenvalue").val();
                var offset = $("#offset").val();
                var newoffset = Number(offset) + Number(6);
                //var ids = $('article.portfolio-item.'+cat).attr('id');
                var ids = [];
                $('article.portfolio-item.'+cat).each(function( index ) {
                    ids[index] = $(this).attr('id');
                });



                 var url = "<?php //echo url('loadmore/'); ?>/"+cat+"/"+tech_offset;
                //var url = "<?php //echo url('loadmore/'); ?>/"+cat+"/"+ids+"/"+offset;
                //alert(url);

                $.ajax({url: url,
                    success: function(result){
                       // alert(result);
                        //$("#listitem1").append(result);
                        //$(".projects-container .row:first").empty();
                        $(".projects-container .row:first").append(result);
                        $("#offset").val($("article.portfolio-item."+cat).size());
                }});
            } */
            ...
            function getdata(){
              ...
              //  alert(id); return false;
               //  //var d = '{"ids":["' + ar.join('","') + '"],"second":]"' + array2.join('","') + '"]}';
               // var d = '{"_token": csrf,"ids":["' + id.join('","') + '"],"cat":"'+cat+'","offset":"'+offset+'"}';
                var url = "<?php echo url('loadmore/'); ?>";
            ...
            /*var lastScrollTop = 0;
                $(window).scroll(function(event){
                    var verificaHorario = $('#portfolio').find('article').length;

                    if(verificaHorario > 0){
                        getdata();
                    }
                  //  verificaHorario.length;
