...
.scrollup {
      ...
      display:none;
      text-indent:-9999px;
      background: url('../template/frontend/images/icon_top.png') no-repeat;
    }
    </style>
  </head>
<style type="text/css">
  ...
  <section class="banner-img portfolio" style="background:rgba(255,255,255,0.8) url(/our-work/public/images/bg.png);">
     <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="tech_list">
                  <?php $technologyid = DB::table('accesstoken')->where('accesstoken', '=', $token)->pluck('technology')->first();  ?>
                    <button class="button_all arrow_box" style="@if($technologyid != 'all'){{ 'background-color: white; color: black;' }} @endif">
                        All
                    </button>
                    @if($token =="")  
                        <nav class="greedy">
                        ...
                        @foreach($technologies as $technology)
                            <li class="color_change @if($technologyid == $technology->technology_id){{ 'redBorder' }}@endif">
                                <a href="javascript:void(0);" class="technology_change @if($technologyid == $technology->technology_id){{ 'selected1' }}@endif" data-id="{{ $technology->technology_id }}">
                    ...
                    @else
                        ...
                        @foreach($technologies as $technology)
                            <li class="color_change @if($technologyid == $technology->technology_id) redBorder @endif">
                                <a href="javascript:void(0);" @if($technologyid == $technology->technology_id)  class="technology_change selected1" data-id="{{ $technology->technology_id }}" @endif>
                                    {{ $technology->technology_name }}
                                </a>    
                            </li>
                         @endforeach  
   ...
   <div class="container-fluid">
        <div class="row postList">
            <input type="hidden" id="loading_data" value="0">
...
<a href="#" class="scrollup">Scroll</a>
    ...
    <script>
        ...
        $('.button_all').click(function(){
            ...
            $('.greedy .links li,.hidden-links li').removeClass('redBorder');
        ...
        $('#category_menu li ul li a').click(function(e) {
            ...
            if (clicked.hasClass('selected')){
                ...
                $('#category_menu li ul li').removeClass('selected');
                clicked.addClass('selected');
                clicked.parent().addClass('selected');
                ...
                if(elem.data('id') == tagId){
                    ...
                    $(tag_menu + " li ul li a.selected" ).each(function( index ) {
                        ...
                        if(elem1.data('id') == tagId){
                            ...
                            elem1.parent().removeClass('selected');
        ...
        function getPortfolio(){
            ...
            if($("#category_menu li ul li").find('a.selected.prepend')){
                var category = $("#category_menu ").find('li ul li a.selected.prepend').data('id');
                if(data == ''){
            ...
            if($("#tag_menu li ul li").find('a.selected')){
                var tag=[];
                $('#tag_menu a.selected.prepend').each(function () {
            ...
            if($("#theme_menu li ul li").find('a.selected')){
                var theme=[];
                $('#theme_menu a.selected.prepend').each(function (){
            ...
            if($("#package_menu li ul li").find('a.selected')){
                var package=[];
                $('#package_menu a.selected.prepend').each(function (){
