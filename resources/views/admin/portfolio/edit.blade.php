                ...
                <div class="row">
                    <form class="form-horizontal" role="form" method="post" action="{{url('admin/portfolio/update')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="duration" placeholder="Enter hours ex(01:00,10:50,30:00..)" class="col-xs-10 col-sm-5"  value="{{$results[0]->duration}}" name="duration" required />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                @if ($results[0]->image and file_exists('template/frontend/images/'.$results[0]->image))
                                @if ($results[0]->image!='no-image-icon-15.png' and $results[0]->image!='No_img_portfolio.jpg')
                                <div class="portfolio_image_{{ $results[0]->portfolioid }}">
                                    <br/><input type="hidden" id="id-input-file-2" name="old_image" value="{{$results[0]->image}}"/>
                                    <img src="{{ URL::asset('template/frontend/images/'.$results[0]->image) }}" alt="" height="100px" width="100px"/>
                                    <a href="javascript:;" id="removeImage" data-id="{{ $results[0]->portfolioid }}">[x] Remove Image</a>
                                </div>
                                @endif
                                @endif
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label>
                                    <input type="checkbox" class="ace" name="status" value="0" {{ (($results[0]->status=='0') ? 'checked' : '')}}>
                                    <span class="lbl"> Yes</span>
                                </label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea id="form-field-2" placeholder="Enter text" class="col-xs-10 col-sm-5" name="notes">{{$results[0]->notes}}</textarea>
                                @if ($errors->has('notes'))
