	...
	<div class="main-content">
		<div class="main-content-inner">
			...
			<div class="page-content">
				...
				<div class="row">
					<form role="form" method="post" action="{{url('admin/client/add')}}">
						{{ csrf_field() }}
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Client name </label>

							<div class="col-sm-9">
								<input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="name" value="{{old('name')}}" required>
								@if($errors->has('name'))
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="email" value="{{old('email')}}" required>
								@if($errors->has('email'))
